...
<html>
    <head>
        ...
        <!-- Re-use cùng style với trang create (rút gọn) -->
        <style>
            *{
    ...
    <body>
        ...
        <section class="card">
            ...
            <form action="${pageContext.request.contextPath}/products?action=edit" method="post">
                ...
                <input type="datetime-local" name="importDate"
                       value="<fmt:formatDate value='${product.importDate}' pattern='yyyy-MM-dd''T''HH:mm' />" />
